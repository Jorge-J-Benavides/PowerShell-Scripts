...
$MyPath = $PSScriptroot + "\ListOfComputers.txt" 
...
$VPCOtherComputers = $ComputerList | Select-String -Pattern ('VPC-O2-\d')
$VPCOtherTablets = $ComputerList | Select-String -Pattern ('VPC-TC2-\d')
